	...
	if($last_inv->id != null)
		...
		* {
		...
		<?php endif; ?>
				...
				$file = $dompdf->output();
					$fileName = 'hma-rechnung-'.$month.'-'.$year;
		...
		//wp_mail('carmen.schwenk@herma.de', $fileName, $content, $headers, $attachments);
		wp_mail('it@airport-parking-stuttgart.de', $fileName."-t", $content, $headers, $attachments);
	}
}
?>