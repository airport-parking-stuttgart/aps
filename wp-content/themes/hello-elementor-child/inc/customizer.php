<?php
/**
 * IT Web24 Theme Theme Customizer
 *
...
function itweb24_theme_customize_register( $wp_customize ) {

    //Style Preset
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'itweb24_theme' ),
            //'description' => __( 'This is a section for the typography', 'itweb24_theme' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'itweb24_theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'itweb24_theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_color_scheme_setting', array(
        'label' => __( 'Color Scheme', 'itweb24_theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'itweb24_theme' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'itweb24_theme' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'itweb24_theme' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','itweb24_theme' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'itweb24_theme' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'itweb24_theme'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'itweb24_theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'itweb24_theme' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'itweb24_theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'itweb24_theme' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'itweb24_theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'itweb24_theme' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'cdn_assets_setting', array(
        'default' => __( 'no','itweb24_theme' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'itweb24_theme' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'itweb24_theme' ),
    ...
    $wp_customize->add_setting( 'itweb24_theme_logo', array(
        //'default' => __( '', 'itweb24_theme' ),
        'sanitize_callback' => 'esc_url',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'itweb24_theme_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'itweb24_theme' ),
        'section'  => 'title_tagline',
        'settings' => 'itweb24_theme_logo',
    ) ) );

}
add_action( 'customize_register', 'itweb24_theme_customize_register' );

add_action( 'wp_head', 'itweb24_theme_customizer_css');
function itweb24_theme_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function itweb24_theme_customize_preview_js() {
    wp_enqueue_script( 'itweb24_theme_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'itweb24_theme_customize_preview_js' );
