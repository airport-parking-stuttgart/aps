...
<?php if (isset($_GET['edit_booking'])) {
    require_once 'edit-user-booking.php';
} else { ?>
<style>
.update{
            ...
            <div class="col-md-5">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/inc/assets/images/arrow-parking.png" alt="">
                        ...
                        <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"
                            class="active">
                            <span itemprop="name"> Buchungen </span>
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-12 col-lg-9">
				...
				<div class="col-sm-12 col-md-12 col-lg-12 booling_tbl">
					<?php if(count($bookings) > 0 && $bookings[0] != null): ?>
					<table class="table">
						<thead>
						<tr>
							<th>Nr.</th>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<!--<td><a href="<?php echo $_SERVER['REQUEST_URI'] ?>?edit_booking=<?php echo $booking->order_id; ?>">Bearbeiten</a></td>-->
								</tr>
							<?php $p++; endforeach; ?>	
						</tbody>
					</table>
