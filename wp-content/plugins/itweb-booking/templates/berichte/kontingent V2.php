							...
							<?php $k = 1; foreach ($dateParklots as $dateParklot) : ?>
								...
								*/
								...
								<div style="width: 310px;" class="table-col">
									...
									if(($apg_ph_used_r[$i] + $dateParklot->used) > $aps_ph_contingent)
										$background = "yellow";
									else
										$background = "";
									?>
								...
								<div class="table-col">
									...
									if($dateParklot->used > $dateParklot->contigent)
										$background = "yellow";
									else
										$background = "";
									?>		
								...
								<div class="table-col">
									...
									if($totalUsedPH > $totalContigentPH)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div style="width: 300px;" class="table-col">
									...
									if(($apg_od_used_r[$i] + $dateParklot->used) > $aps_od_contingent)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div class="table-col">
									...
									if($totalUsedOD > $totalContigentOD)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div style="width: 300px;" class="table-col">
									...
									if(($apg_sie_used_r[$i] + $dateParklot->used) > $aps_sie_contingent)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div class="table-col">
									...
									if($totalUsedSIE > $totalContigentSIE)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div style="width: 300px;" class="table-col">
									...
									if(($apg_osth_used_r[$i] + $dateParklot->used) > $aps_osth_contingent)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div class="table-col">
									...
									if($totalUsedOSTH > $totalContigentOSTH)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div style="width: 300px;" class="table-col">
									...
									if(($apg_ostp_used_r[$i] + $dateParklot->used) > $aps_ostp_contingent)
										$background = "yellow";
									else
										$background = "";
									?>	
								...
								<div class="table-col">
									...
									if($totalUsedOSTP > $totalContigentOSTP)
										$background = "yellow";
									else
										$background = "";
									?>	
