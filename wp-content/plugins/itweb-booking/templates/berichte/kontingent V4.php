			...
			<div class="TabelleV5-2">
				<div class="parklots-data-table" id="top">
					<div class="table-col-wrapper">
						...
						<?php endforeach; ?>
						<div class="table-col">
							<p class="th ausen-border-top ausen-border-right">Summe APS</p>
						...
						<div class="table-col">
							<p class="th ausen-border-top ausen-border-right">Summe HEX</p>
							<div class="th-total grid-three">
								<strong><p class="">Gebucht</p></strong>
								<p>Frei</p>
								<p class="ausen-border-right">Gesamt</p>
						...
						<div class="table-col">
							<p class="th ausen-border-top ausen-border-right">Summe Parkos</p>
							<div class="th-total grid-three">
								<strong><p class="">Gebucht</p></strong>
								<p>Frei</p>
								<p class="ausen-border-right">Gesamt</p>
						...
						<div class="table-col-wrapper">
							...
							<?php $k = 1; foreach ($dateParklots as $dateParklot) : ?>
								...
								if($dateParklot->order_lot == 1){
									$freeAPS = ((int)$dateParklot->contigent - (int)$dateParklot->used) > 0 ?
									(int)$dateParklot->contigent - (int)$dateParklot->used : 0;
								...
								if($dateParklot->order_lot == 5){
									$freeHEX = ((int)$dateParklot->contigent - (int)$dateParklot->used) > 0 ?
									(int)$dateParklot->contigent - (int)$dateParklot->used : 0;																		
								...
								*/
								...
								if($dateParklot->order_lot == 35){
									$freePA = ((int)$dateParklot->contigent - (int)$dateParklot->used) > 0 ?
									(int)$dateParklot->contigent - (int)$dateParklot->used : 0;																		
							...
							<div class="table-col">								
								...
								?>	
								<div class="grid-three">
									<strong><p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> produkt-trenner tr-total-ph-<?php echo $i % 2; ?> <?php echo $text_color ?>  <?php echo $background ?>"><?php echo $totalUsedAPS . "<br>"; echo $totalContigentAPS != 0 ? number_format($totalUsedAPS / $totalContigentAPS * 100, 2,".",".") : "0.00"; echo "%"; ?></p></strong>
									...
									<p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> ausen-border-right tr-total-ph-<?php echo $i % 2; ?>"><?php echo $totalContigentAPS ?></p>
								</div>
							</div>
							<div class="table-col">								
								<?php
								...
								?>	
								<div class="grid-three">
									<strong><p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> produkt-trenner tr-total-ph-<?php echo $i % 2; ?> <?php echo $text_color ?>  <?php echo $background ?>"><?php echo $totalUsedHEX . "<br>"; echo $totalContigentHEX != 0 ? number_format($totalUsedHEX / $totalContigentHEX * 100, 2,".",".") : "0.00"; echo "%"; ?></p></strong>
									...
									<p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> ausen-border-right tr-total-ph-<?php echo $i % 2; ?>"><?php echo $totalContigentHEX ?></p>
								</div>
							</div>
							<div class="table-col">								
								<?php
								...
								?>	
								<div class="grid-three">
									<strong><p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> produkt-trenner tr-total-ph-<?php echo $i % 2; ?> <?php echo $text_color ?>  <?php echo $background ?>"><?php echo $totalUsedPA . "<br>"; echo $totalContigentPA != 0 ? number_format($totalUsedPA / $totalContigentPA * 100, 2,".",".") : "0.00"; echo "%"; ?></p></strong>
									...
									<p class="<?php echo $i == $dates-1 ? "ausen-border-bottom" : "" ?> ausen-border-right tr-total-ph-<?php echo $i % 2; ?>"><?php echo $totalContigentPA ?></p>
								</div>
							</div>
							<div class="table-col">
								<?php
