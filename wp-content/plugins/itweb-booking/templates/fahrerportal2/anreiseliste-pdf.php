...
foreach ($result as $r) {
	...
	if($zeile - ($umbruch + 1) == 0){
		$html .= "<h4 style='text-align:center'>Anreiseliste Shuttle | " . $date . " | Seite " . $seite . " von " . ceil($total_rows / 25) . "</h4>";
	...
	$betrag = '-';
	if ($r->Bezahlmethode == 'Barzahlung' && $r->Status != "wc-cancelled")
		$betrag = $r->Betrag;
	else
		$betrag = '-';
    ...
    $html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . date("d.m.Y",  strtotime($r->Anreisedatum)) . "</td>";
    $html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $anreisezeit . "</td>";
    $html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $r->Personenanzahl . "</td>";
    $html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $parkplatz . "</td>";
    $html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $abreisedatum . "</td>";
	$html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'></td>";
	$html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'></td>";
	$html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $betrag . "</td>";
	$html .= "<td style=' font-size: 12px; border: 1px solid black; padding:3px;'>" . $r->FahrerAn . "</td>";
