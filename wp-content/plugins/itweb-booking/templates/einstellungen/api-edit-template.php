...
$broker_id = Database::getInstance()->getBrokerIdByApi($_GET['edit']);
$id = $broker_id->id;
	...
	<div class="page-body">
		<form action="#" method="POST">
			<div class="row ui-lotdata-block ui-lotdata-block-next api_code-wrapper">
				<h5 class="ui-lotdata-title">Produkte verlinken</h5>
			...
			<div class="row m10">
				...
				<div class="col-1">
					<a href="<?php echo '/wp-admin/admin.php?page=api' ?>" class="btn btn-secondary" >Zurück</a>
				</div>
			</div>
		</form>
    </div>
