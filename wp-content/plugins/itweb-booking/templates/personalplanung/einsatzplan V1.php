...
<div class="page container-fluid <?php echo $_GET['page'] ?>">
	...
	<div class="page-body">		
					...
					<div class="table-wrapper" style="width: 100%; overflow: scroll;" >						
						<table class="table table-sm" id="table1">
							<thead>
								<tr>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten' || $current_user->user_login == 'hakan'): ?>
									<th style="position: sticky;left:0;background-color:white;">KW <input type="text" name="kw_1" size="3" min="1" max="52" value="<?php echo $kw1; ?>" readonly><br><span><?php echo $week1 ?></span></th>
									<?php else:?>
									<th style="position: sticky;left:0;background-color:white;">KW <?php echo $kw1; ?><br><span><?php echo $week1 ?></span></th>
									<?php endif; ?>
							...
							<?php $i = $r = $ma = 1; foreach($users_fahrer as $fahrer): ?>
								<?php
									if(isset($_GET['role'])){
										if($_GET['role'] == "buro" && $fahrer->role == "fahrer")
											continue;
								...
								<?php 
									...
									if($fahrer->role == "admin2" || $fahrer->role == "koordinator" || $fahrer->role == "administrator"){
										if($fahrer->user_id == 7 || $fahrer->user_id == 8){
											$linaColor = 'color_ad';
											$left_color = '#00ccff';
										}
									...
									if($ma >= $r){
										if($ma >= $r && $ma < $r+5){
											$light_color = "#e6fffe";
											$dark_color = "#88fcf8";
											$left_color = $dark_color;
										}
										elseif($ma >= $r+5 && $ma < $r+9){
											$light_color = "#f4e0ff";
											$dark_color = "#db99ff";
											$left_color = $dark_color;
										}
										elseif($ma >= $r+9 && $ma < $r+14){
											$light_color = "#ffe5e3";
											$dark_color = "#ffa7a1";
											$left_color = $dark_color;
										}
									...
									if($data->mo != null && !str_contains($data->mo, '-') && !str_contains($data->mo, 'K') && !str_contains($data->mo, 'F') && !str_contains($data->mo, '?'))
										$read_mo = "readonly";
									else
										$read_mo = "";
									
									if($data->di != null && !str_contains($data->di, '-') && !str_contains($data->di, 'K') && !str_contains($data->di, 'F') && !str_contains($data->di, '?'))
										$read_di = "readonly";
									else
										$read_di = "";
									
									if($data->mi != null && !str_contains($data->mi, '-') && !str_contains($data->mi, 'K') && !str_contains($data->mi, 'F') && !str_contains($data->mi, '?'))
										$read_mi = "readonly";
									else
										$read_mi = "";
									
									if($data->do != null && !str_contains($data->do, '-') && !str_contains($data->do, 'K') && !str_contains($data->do, 'F') && !str_contains($data->do, '?'))
										$read_do = "readonly";
									else
										$read_do = "";
									
									if($data->fr != null && !str_contains($data->fr, '-') && !str_contains($data->fr, 'K') && !str_contains($data->fr, 'F') && !str_contains($data->fr, '?'))
										$read_fr = "readonly";
									else
										$read_fr = "";
									
									if($data->sa != null && !str_contains($data->sa, '-') && !str_contains($data->sa, 'K') && !str_contains($data->sa, 'F') && !str_contains($data->sa, '?'))
										$read_sa = "readonly";
									else
										$read_sa = "";
									
									if($data->so != null && !str_contains($data->so, '-') && !str_contains($data->so, 'K') && !str_contains($data->so, 'F') && !str_contains($data->so, '?'))
										$read_so = "readonly";
									else
										$read_so = "";
								...
								<tr style="background: <?php echo ($i % 2) != 1 ? $dark_color : $light_color?>" class="<?php echo $linaColor ?>" id="<?php echo $fahrer->user_id ?>"  <?php $left_color = ($i % 2) == 1 && $linaColor == '' ? $dark_color : $left_color == "" ? $light_color : $left_color ?>>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="mo_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->mo != null ? $data->mo : "" ?>" <?php echo $read_mo ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->mo_pause, 1, ".", ".");
										}								
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="di_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->di != null ? $data->di : "" ?>" <?php echo $read_di ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php								
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->di_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="mi_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->mi != null ? $data->mi : "" ?>" <?php echo $read_mi ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->mi_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="do_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->do != null ? $data->do : "" ?>" <?php echo $read_do ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->do_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="fr_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->fr != null ? $data->fr : "" ?>" <?php echo $read_fr ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->fr_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="sa_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->sa != null ? $data->sa : "" ?>" <?php echo $read_sa ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->sa_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<td><input class="day_val" type="text" name="so_<?php echo $fahrer->user_id ?>" size="3" value="<?php echo $data->so != null ? $data->so : "" ?>" <?php echo $read_so ?> oninput="this.value = this.value.replace(/[^0-9-FK]/g, '').replace(/(\-.*?)\-.*/g, '$1').replace(/^0[^-]/, '0');"></td>
									<?php else:?>
									...
									<?php
										...
										if($times[1] != null && $times[0] != null){
											$diff_times[$fahrer->user_id] += number_format((int)$times[1] - (int)$times[0], 1, ".", ".");
											$diff_times[$fahrer->user_id] += number_format($data->so_pause, 1, ".", ".");
										}
									?>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									...
									<?php endif; ?>
									<td><?php echo get_user_meta( $fahrer->user_id, 'std_w', true ) ?></td>
		...
		<style>
		th{
			vertical-align:top; font-size: 12px; border: 1px solid black; padding:3px; font-weight: bold; background-color: #2d4154; color: #fff; white-space: nowrap;
		}
		td{
			font-size: 12px; border: 1px solid black; padding:3px; white-space: nowrap;
		}
		</style>
		<div class="row">
			<div class="col-sm-12 col-md-12" >
				...
				<table class="table" style=' font-size: 12px; border-collapse:collapse; width: 100%'>
					...
					<tbody class="row_position_table1">
						...
						<tr>
							...
							<td><?php echo $data->bus_mo != null && $data->bus_mo != 0 ? $data->bus_mo : "" ?></td>	
							<td><?php echo $data->mo != null ? $data->mo : "" ?></td>
							<?php
								$times = explode("-", $data->mo);
							...
							?>
							<td><?php echo $data->mo_pause != null ? $data->mo_pause : "" ?></td>
							<td><?php echo $data->bus_di != null && $data->bus_di != 0 ? $data->bus_di : "" ?></td>
							<td><?php echo $data->di != null ? $data->di : "" ?></td>
							<?php								
								$times = explode("-", $data->di);
								if($times[1] != null && $times[0] != null){
							...
							?>
							<td><?php echo $data->di_pause != null ? $data->di_pause : "" ?></td>								
							<td><?php echo $data->bus_mi != null && $data->bus_mi != 0 ? $data->bus_mi : "" ?></td>
							<td><?php echo $data->mi != null ? $data->mi : "" ?></td>
							<?php
								$times = explode("-", $data->mi);
								if($times[1] != null && $times[0] != null){
							...
							?>
							<td><?php echo $data->mi_pause != null ? $data->mi_pause : "" ?></td>								
							<td><?php echo $data->bus_do != null && $data->bus_do != 0 ? $data->bus_do : "" ?></td>
							<td><?php echo $data->do != null ? $data->do : "" ?></td>
							<?php
								$times = explode("-", $data->do);
								if($times[1] != null && $times[0] != null){
							...
							?>
							<td><?php echo $data->do_pause != null ? $data->do_pause : "" ?></td>								
							<td><?php echo $data->bus_fr != null && $data->bus_fr != 0 ? $data->bus_fr : "" ?></td>
							<td><?php echo $data->fr != null ? $data->fr : "" ?></td>
							<?php
								$times = explode("-", $data->fr);
								if($times[1] != null && $times[0] != null){
							...
							?>
							<td><?php echo $data->fr_pause != null ? $data->fr_pause : "" ?></td>								
							<td><?php echo $data->bus_sa != null && $data->bus_sa != 0 ? $data->bus_sa : "" ?></td>
							<td><?php echo $data->sa != null ? $data->sa : "" ?></td>
							<?php
								$times = explode("-", $data->sa);
								if($times[1] != null && $times[0] != null){
							...
							?>
							<td><?php echo $data->sa_pause != null ? $data->sa_pause : "" ?></td>								
							<td><?php echo $data->bus_so != null && $data->bus_so != 0 ? $data->bus_so : "" ?></td>
							<td><?php echo $data->so != null ? $data->so : "" ?></td>
							<?php
								$times = explode("-", $data->so);
								if($times[1] != null && $times[0] != null){
					...
					<div class="table-wrapper" style="width: 100%; overflow: scroll;">						
						<table class="table table-sm">
							<thead>
								<tr>
									<?php if($current_user->user_login == 'sergej' || $current_user->user_login == 'aras' || $current_user->user_login == 'cakir' || $current_user->user_login == 'soner' || $current_user->user_login == 'birten'  || $current_user->user_login == 'hakan'): ?>
									<th style="position: sticky;left:0;background-color:white;">KW <input type="text" name="kw_2" size="3" min="1" max="52" value="<?php echo $kw2; ?>" readonly><br><span><?php echo $week2 ?></span></th>
									<?php else:?>
									<th style="position: sticky;left:0;background-color:white;">KW <?php echo $kw2; ?><br><span><?php echo $week2 ?></span></th>
									<?php endif; ?>
									<th class="border_left">Bus</th>
