...
$weeks_s = ($date->format("W") === "53" ? 53 : 52);
...
$k = $kw2 < 10 ? "0" . $kw2 : $kw2;
$timestamp_montag = strtotime("{$year2}-W{$k}");
$firstDay = date("d.m.Y", $timestamp_montag);
...
$k = $kw3 < 10 ? "0" . $kw3 : $kw3;
$timestamp_montag = strtotime("{$year3}-W{$k}");
$firstDay = date("d.m.Y", $timestamp_montag);
...
$k = $kw4 < 10 ? "0" . $kw4 : $kw4;
$timestamp_montag = strtotime("{$year4}-W{$k}");
$firstDay = date("d.m.Y", $timestamp_montag);
...
$k = $kw5 < 10 ? "0" . $kw5 : $kw5;
$timestamp_montag = strtotime("{$year5}-W{$k}");
$firstDay = date("d.m.Y", $timestamp_montag);
...
$k = $kw6 < 10 ? "0" . $kw6 : $kw6;
$timestamp_montag = strtotime("{$year6}-W{$k}");
$firstDay = date("d.m.Y", $timestamp_montag);
