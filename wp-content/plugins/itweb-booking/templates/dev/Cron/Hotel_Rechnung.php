...
$hotelTransfers_hib = HotelTransfers::getHotelTransfersForInvioce_Hin($month, $year, $user_id);
...
<div class="top-table-info">
	<h3>Rechnung Monat <?php echo $monate[$month]." ".$year; ?></h3>
	<p>Sehr geehrte Damen und Herren,</p>
	<p>im Leistungszeitraum vom <strong>1.<?php echo " " . $monate[$month] ?><?php echo " ".$year ?> bis zum 
			<?php echo cal_days_in_month(CAL_GREGORIAN, $month, $year) . '. ' . $monate[$month] . ' ' . $year ?>
...
<?php if(count($transferlist) > 0): ?>
	<h3>Transferliste <?php echo $monate[$month]." ".$year; ?></h3>
