...
$allorders = Database::getInstance()->get_fahrerliste("Anreise", "valet", $filter);
...
<div class="page container-fluid <?php echo $_GET['page'] ?>">
	...
	<div class="page-body">
			...
			<div class="row ui-lotdata-block ui-lotdata-block-next">
				...
				<div class="col-sm-12 col-md-12 ui-lotdata">
					<div class="row">
						...
						<div class="col-sm-12 col-md-2">
							<a href="<?php echo '/wp-admin/admin.php?page=anreiseliste-valet' ?>" class="btn btn-secondary d-block w-100">Zurücksetzen</a>
						</div>
					</div><br>
					<div class="row">
		...
		<div class="btn">
			<form action="<?= get_site_url() . '/wp-content/plugins/itweb-booking/templates/fahrerportal/anreiseliste-valet-pdf.php'; ?>" method="post">
				...
				foreach ($allorders as $order) : ?>
					...
					<tr style="background-color: <?php echo $color ?> !important" export-color="<?php echo $color ?>" class="row<?php echo $i % 2; ?>">
						...
						<?php if ($order->is_for != 'hotel') : ?>
							<td>
								<a href="#" class="save-anreiseliste-valet-row">Speichern</a>
							</td>
						<?php else :  ?>
							<td>
								<p class="">-</p>
