...
$_SESSION['service_type'] = "Valet";


$allorders = Database::getInstance()->get_fahrerliste("Abreise", "valet", $filter);
...
<div class="page container-fluid <?php echo $_GET['page'] ?>">
	...
	<div class="page-body">
			...
			<div class="row ui-lotdata-block ui-lotdata-block-next">
				...
				<div class="col-sm-12 col-md-12 ui-lotdata">
					<div class="row">
						...
						<div class="col-sm-12 col-md-2">
							<a href="<?php echo '/wp-admin/admin.php?page=abreiseliste-valet' ?>" class="btn btn-secondary d-block w-100">Zurücksetzen</a>
						</div>
					</div><br>
					<div class="row">
		...
		<div class="btn">
			<form action="<?= get_site_url() . '/wp-content/plugins/itweb-booking/templates/fahrerportal/abreiseliste-valet-pdf.php'; ?>" method="post">
			...
			<tbody>
				...
				<?php
					...
					<tr style="background-color: <?php echo $color ?> !important" export-color="<?php echo $color ?>" class="row<?php echo $i % 2; ?>">
						...
						<td class="order-kennzeichen">
							<input type="text" style="width:90px;" value="<?php echo $order->Kennzeichen ?>" class="transparent-input"><span style="display: none;"><?php echo $order->Kennzeichen ?></span>
						</td>
						<td class="order-fahrzeug">
							<input type="text" style="width:90px;" value="<?php echo get_post_meta($order->order_id, 'Fahrzeugmodell', true ) ?>" class="transparent-input"><span style="display: none;"><?php echo get_user_meta( $ma->user_id, 'Fahrzeugmodell', true ) ?></span>
						</td>
						<td class="order-farbe">
							<input type="text" style="width:90px;" value="<?php echo get_post_meta($order->order_id, 'Fahrzeugfarbe', true ) ?>" class="transparent-input"><span style="display: none;"><?php echo get_user_meta( $ma->user_id, 'Fahrzeugfarbe', true ) ?></span>
						</td>
						...
						<?php if ($order->is_for != 'hotel') : ?>
							<td>
								<a href="#" class="save-abreiseliste-valet-row">Speichern</a>
							</td>
						<?php else :  ?>
							<td>
								<p class="">-</p>
