(function( $ ) {
	...
	$(function(){
		...
		$( "#srfw_helpicon" ).click(function() {
		  ...
		  <p><b>- Remove All Reviews:</b> Allows you to delete all reviews in the plugin.</p> \
		  ', "");
		});
		...
		$( "#srfw_removeallbtn" ).click(function() {
		  ...
		  openpopup("Are you sure?", '<p>This will delete all reviews in the plugin database including the ones you manually entered. It Does NOT affect your reviews in woocommerce.</p>', '<a class="button dashicons-before dashicons-no" href="?page=srfw-reviews&opt=delall&_wpnonce='+sec+'">Remove</a>');
		});	
