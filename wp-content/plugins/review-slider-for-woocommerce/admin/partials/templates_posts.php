 ...
 */
	...
	if (isset($_POST['srfw_submittemplatebtn'])){
		...
		$templatemiscarray['postfilter']=sanitize_text_field($_POST['srfw_t_postfilter']);
...
<form name="newtemplateform" id="newtemplateform" action="?page=srfw-templates_posts" method="post" onsubmit="return validateForm()">
	<table class="srfw_margin10 form-table ">
		<tbody>
			...
			<tr <?php if($haswidgettemplate==false){echo "style='display:none;'";} ?> class="srfw_row">
				<th scope="row">
...
<tr class="srfw_row">
				<th scope="row">
					<?php _e('Template Style Settings:', 'review-slider-for-woocommerce'); ?>
				</th>
				<td>
					<div class="w3_wprs-row">
						  <div class="w3_wprs-col s6">
							<div class="w3_wprs-col s6">
								...
								<?php _e('Template Style:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Show Stars:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Show Date:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Border Radius:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Background Color 1:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row wprevpre_bgcolor2">
								<?php _e('Background Color 2:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Text Color 1:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row">
								<?php _e('Text Color 2:', 'review-slider-for-woocommerce'); ?>
								</div>
								<div class="wprevpre_temp_label_row wprevpre_tcolor3">
								<?php _e('Text Color 3:', 'review-slider-for-woocommerce'); ?>
								</div>
							</div>
							<div class="w3_wprs-col s6">
								<div class="wprevpre_temp_label_row">
				...
				?>
								...
								<a id="srfw_pre_resetbtn" class="button"><?php _e('Reset Colors', 'review-slider-for-woocommerce'); ?></a>
							</div>
						  </div>
			...
			<tr class="srfw_row">
				<th scope="row">
					<?php _e('Add Read More Link:', 'review-slider-for-woocommerce'); ?>
				</th>
				<td><div class="divtemplatestyles">
					<label for="srfw_t_read_more"><?php _e('', 'review-slider-for-woocommerce'); ?></label>
					...
					<label for="srfw_t_read_more_text">&nbsp;&nbsp;<?php _e('Read More Text:', 'review-slider-for-woocommerce'); ?></label>
					...
					<p class="description">
					<?php _e('Allows you to cut off long reviews and add a read more link that will show the rest of the review when clicked.', 'review-slider-for-woocommerce'); ?></p>
				</td>
			</tr>
			
			<tr class="wprevpro_row revselectedhide">
				<th scope="row">
					<?php _e('Filter By Post', 'review-slider-for-woocommerce'); ?>
				</th>
				<td><div class="">
					<label for="srfw_t_postfilter"><?php _e('Turn on Post ID filter:', 'review-slider-for-woocommerce'); ?></label>
					<select name="srfw_t_postfilter" id="srfw_t_postfilter">
					  <option value="yes" <?php if($template_misc_array['postfilter']=="yes"){echo "selected";} ?>><?php _e('Yes', 'review-slider-for-woocommerce'); ?></option>
					  <option value="no" <?php if($template_misc_array['postfilter']=="no"){echo "selected";} ?>><?php _e('No', 'review-slider-for-woocommerce'); ?></option>
					</select>&nbsp;&nbsp;&nbsp;
					</div>
					<p class="description">
					<?php _e('When this is turned on and the review template is placed on a Product Page then only reviews for that specific Product will be shown.', 'review-slider-for-woocommerce'); ?></p>
				</td>
			</tr>
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<span><?php _e('Upgrade to the Pro Version of this plugin to access tons of slider settings! Get the Pro Version <a href="https://wpreviewslider.com/">here</a>!', 'review-slider-for-woocommerce'); ?></span>
				</td>
			</tr>
