...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    <?php if( $form_position == 'top' ) : ?>
        <?php include 'review-form-two.php'; ?>
    <?php endif; ?> 
        ...
        <div class="rx_listing_container_style_2">
            <ul class="rx_listing_style_2 rx_listing_filter_style_2" id="rx-commentlist">
                ...
                if(isset($reviewx_shortcode) && !empty($reviewx_shortcode['rx_product_id'])) {
                    $reviewx_shortcode['rx_post_type']  = get_post_type( get_the_ID() );
                                ...
                                <div class="rx_author_info">
                                    <div class="rx_thumb"> 
                                        <?php 
                                            ...
                                            \ReviewX_Helper::get_gravatar( $comment_object, get_post_type( get_the_ID() ) );									
                                        ?> 
                                    </div>
                                                        ...
                                                        <a class="rx-popup-video" href="<?php echo esc_url( $comment_video_url ); ?>">
                                                            ...
                                                            <div class="rx_overlay">
                                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
                                                                    ...
                                                                    <path class="st0" d="M21.2,2.2C12.2-3,4.9,1.3,4.9,11.7v76.7c0,10.4,7.3,14.6,16.3,9.5l67-38.4c9-5.2,9-13.6,0-18.7L21.2,2.2z M21.2,2.2"/>
                                                                </svg>
                                                            </div>
                                                        </a>
                                                    </div>
