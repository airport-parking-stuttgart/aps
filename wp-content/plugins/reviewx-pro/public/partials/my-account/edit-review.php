<?php 
    ...
    $review_criteria 			= isset($settings->review_criteria) ? $settings->review_criteria : [];
    ...
    $rating_style 				= isset($settings->rating_style) ? $settings->rating_style : '';
...
<div class="rx-form rx-hide" id="rx-edit-form">

    <div class="rx-flex-container">
        <a href="#" class="rx-edit-cancel rx-form-btn rv-btn">
    ...
    <div class="rx-flex-grid-container rx_short_summery_wrap">
        ...
        <div class="rx-flex-grid-66 short_summary">
            <table class="responstable order_summery table table-striped table-dark">
                <tbody>
                    <tr>
                        <td style="width: 30%;"><?php esc_html_e( 'Order No:', 'reviewx-pro' ); ?> </td>
                        <td style="width: 70%;" scope="row">#<span id="edit-prod-order"></span></td>
                    </tr>
                    <tr>
                        <td style="width: 30%;"><?php esc_html_e( 'Order Status:', 'reviewx-pro' ); ?></td>
                        <td style="width: 70%;" scope="row">"<span id="edit-prod-order-status"></span>"</td>
                    </tr>
                    <tr>
                        <td style="width: 30%;"><?php esc_html_e( 'Item:', 'reviewx-pro' ); ?></td>
                        <td style="width: 70%;" scope="row"><a id="edit-prod-url" href="" target="_blank"><span id="edit-prod-name"></span></a></td>
                    </tr>
                    <tr>
                        <td style="width: 30%;"><?php esc_html_e( 'Quantity:', 'reviewx-pro' ); ?></td>
                        <td style="width: 70%;" scope="row"><span id="edit-prod-qty"></span>&nbsp;<span><?php esc_html_e( 'pc(s)', 'reviewx-pro' ); ?></span></td>
                    </tr>
                    <tr>
                        <td style="width: 30%;"><?php esc_html_e( 'Price:', 'reviewx-pro' ); ?></td>
                        <td style="width: 70%;" scope="row" id="edit-prod-price"></td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <fieldset>
                <div class="form-row">
                    <div class="rx-form-group rx-flex-grid-100 rv-t">
                        <div class="rx-edit-criteria" id="rx-edit-criteria"></div>
                    </div>
                    <?php if( $allow_review_title == 1 ){ ?> 
                    <div class="rx-flex-grid-100">
                        <input type="text" id="rx-edit-title" class="form-control review-box reviewx_title" name="rx-edit-title" placeholder="<?php esc_attr_e( 'Review title', 'reviewx-pro' ); ?>">
                        <span class="rx-error" id="rx-review-edit-title-error"></span>
                    </div>
                    <?php } ?>
                    <div class="rx-form-group rx-flex-grid-100">
                        <textarea id="rx-edit-text" class="form-control review-box rx-review-box" name="rx-edit-text" placeholder="<?php esc_attr_e( 'Describe your review', 'reviewx-pro' ); ?>"></textarea>
                        <span class="rx-error" id="rx-edit-text-error"></span>
                    </div>                      
                    <?php 
                        // Filter allow image                       
                        $allow_img_data['is_allow_img']      = $allow_img;
                        $allow_img_data['signature']         = 2;
                    ...
                    <div class="rx-flex-grid-100 rv-t">
                        <div class="reviewx_recommended">
                            <h2><?php echo !empty(get_theme_mod('reviewx_form_recommednation_label') ) ? get_theme_mod('reviewx_form_recommednation_label') : __( 'Recommendation:', 'reviewx-pro' ); ?></h2>
                ...
                <div class="rx-form-group rx-form-submit-status"></div>	
                <div class="form-group">
                    <input type="hidden" name="rx-edit-user-id" id="rx-edit-user-id" value="<?php echo get_current_user_id(); ?>">
                    <input type="hidden" name="rx-edit-order-id" id="rx-edit-order-id">
                    <input type="hidden" name="rx-edit-product-id" id="rx-edit-product-id">
                    <input type="hidden" name="rx-review-id" id="rx-review-id">
                    <input type="hidden" name="rx-edit-total-criteria" id="rx-edit-total-criteria" value="<?php echo count($review_criteria); ?>">
                    <input type="hidden" name="rx-edit-nonce" id="rx-edit-nonce" value="<?php echo wp_create_nonce( "special-string" ); ?>">
                    <input name="cancel" class="rx-edit-cancel rx-cancel-btn rx-cancel" value="<?php esc_attr_e( 'Cancel', 'reviewx-pro' ); ?>" type="button">
                    <input name="rx-edit" id="rx-edit" class="submit rx-form-btn rx-form-primary-btn rv-btn" value="<?php esc_attr_e( 'Update', 'reviewx-pro' ); ?>" type="button">
                </div>
            </fieldset>
        </form>
    </div>    
