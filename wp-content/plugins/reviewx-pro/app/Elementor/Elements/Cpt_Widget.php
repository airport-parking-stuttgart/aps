...
class Cpt_Widgets extends Widget_Base
{
		...
		*
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333333',
				'selectors' => [
					'.rx-temp-rating .rx-temp-rating-number  p' => 'color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#9e9e9e',
				'selectors' => [
					'.rx_average_rating .rx-temp-rating-number .temp-rating_5-star' => 'color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.rx_average_rating .rx-temp-rating-number .temp-rating_5-star',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFAF22',
				'selectors' => [
					'.rx_avg_star_color' => 'fill: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [					
					'.rx-temp-rating-star svg' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important;',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#444',
				'selectors' => [
					'.rx-temp-rating  .rx-temp-total-rating-count p' => 'color: {{VALUE}} !important',					
				],
			]
		);	
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.rx-temp-rating .rx-temp-total-rating-count p',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#444',
				'selectors' => [
					'.rx_recommended_box .rx_recommended_box-right .rx_recommended_box_content' => 'color: {{VALUE}} !important',					
				],
			]
		);		
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.rx_recommended_box .rx_recommended_box-right .rx_recommended_box_content',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					' .rx-flex-grid-container .rx_recommended_wrapper hr' => 'border-style: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					' .rx_recommended_wrapper hr' => 'width: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					' .rx_recommended_wrapper hr' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					' .rx_recommended_wrapper hr' => 'border-width: {{SIZE}}{{UNIT}}',
				],
			]
		);	
		...
		* *********************************/
		...
		$this->add_control(
			...
			[
				...
				'default' => '#1a1a1a',
				'selectors' => [
					' .rx-graph-style-2 .progress-bar-t' => 'color: {{VALUE}} !important', 
					' .rx_style_two_free_progress_bar .progressbar-title' => 'color: {{VALUE}}',
					' .vertical .vertical_bar_label' => 'color: {{VALUE}}',										
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => ' .rx-graph-style-2 .progress-bar-t, 
	...
	protected function template_one_style()
    {
			...
			[
				...
				'selectors' => [
					' .rx-filter-bar .rx_filter_header h4, 
					 .rx-filter-bar .rx-short-by h4' => 'color: {{VALUE}}',										
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => ' .rx-filter-bar .rx_filter_header h4,
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx-filter-bar .rx_review_shorting_2 .box select' => 'background-color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#373747',
				'selectors' => [
					' .rx-filter-bar .rx_review_shorting_2 .box select' => 'color: {{VALUE}} !important',					
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx-filter-bar .rx_review_shorting_2 .box .rx-selection-arrow b' => 'border-color: {{VALUE}} transparent transparent transparent !important',					
				],
			]
		);			
		...
		$this->add_control(
			...
			[
				...
				'default' => '#2f4fff',
				'selectors' => [
					' .rx-filter-bar .rx_review_shorting_2 .box .rx-selection-arrow' => 'background-color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ececec',
				'selectors' => [
					' .rx-filter-bar' => 'background-color: {{VALUE}}',					
				],
			]
		);		
		...
		* Start Review Style
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => ' .woocommerce-tabs .rx_listing .rx_review_block .rx_thumb',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					' .woocommerce-tabs .rx_listing .rx_review_block .rx_thumb' => 'border-style: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					' .woocommerce-tabs .rx_listing .rx_review_block .rx_thumb' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					' .woocommerce-tabs .rx_listing .rx_review_block .rx_thumb' => 'border-width: {{SIZE}}{{UNIT}}',
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#373747',
				'selectors' => [
					' .rx_listing .rx_review_block .rx_author_info .rx_author_name h4' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		* *********************************/
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFAF22',
				'selectors' => [
					' .rx_review_sort_list .rx_listing_container .rx_listing .rx_avg_star_color' => 'fill: {{VALUE}} !important',					
				],
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [					
					' .rx_listing .rx_review_block .rx_body .review_rating svg' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important;',					
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#373747',
				'selectors' => [
					' .rx_listing .rx_review_block .review_title' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#9B9B9B',
				'selectors' => [
					' .rx_listing .rx_review_block .rx_body p' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		* *********************************/			
		...
		$this->add_control(
			...
			[
				...
				'default' => '#707070',
				'selectors' => [
					' .rx_listing .rx_review_block .rx_body .rx_review_calender svg .st0' => 'fill: {{VALUE}} !important',
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#6d6d6d',
				'selectors' => [
					' .rx_listing .rx_review_block .rx_body .rx_review_calender' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		if( $this->is_pro() ) {
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing .rx_review_block .rx_body .rx_meta .rx_review_vote_icon p' => 'color: {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#eaeaea',
					'selectors' => [
						' .rx_listing .rx_review_vote_icon .like' => 'background-color: {{VALUE}}',					
					],
				]
			);				
			...
			$this->add_control(
				...
				[
					...
					'default' => '#A4A4A4',
					'selectors' => [
						' .rx_listing .rx_helpful_style_1_svg svg' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#696969',
					'selectors' => [
						' .rx_listing .rx_review_vote_icon .like .rx_helpful_count_val' => 'color: {{VALUE}} !important',				
					],
				]
			);			
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing .rx_review_block .rx_body .rx_meta .rx_share p' => 'color: {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#000',
					'selectors' => [
						' .rx_listing .social-links .wc_rx_btns ul li:nth-child(1) svg' => 'fill: {{VALUE}} ! important',
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#B7B7B8',
					'selectors' => [
						' .rx_listing .social-links .wc_rx_btns ul li:nth-child(2) a svg .st0' => 'fill: {{VALUE}}',					
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#B7B7B8',
					'selectors' => [
						' .rx_listing .social-links .wc_rx_btns ul li:nth-child(3) a svg .st0' => 'fill: {{VALUE}}',					
					],
				]
			);			
			...
			$this->add_control(
				...
				[
					...
					'default' => '#ececec',
					'selectors' => [
						' .rx_listing .rx_review_block + .rx_review_block' => 'border-top: 2px solid {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#ececec',
					'selectors' => [
						' .rx_listing .reviewx_highlight_comment' => 'border-color: {{VALUE}} !important',					
					],
				]
			);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					' .rx_listing .rx_review_block .rx_body .rx_photos' => 'justify-content: {{VALUE}} !important;',
				],
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx_listing_container' => 'background-color: {{VALUE}}',					
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ececec',
				'selectors' => [
					' .rx_listing_container' => 'border-color: {{VALUE}}',					
				],
			]
		);
		...
		* *********************************/
		...
		if( $this->is_pro() ) {
			...
			$this->add_control(
				...
				[
					...
					'default' => '#2f4fff',
					'selectors' => [
						' .rx_listing .rx_review_block .children .rx_thumb svg .st0' => 'fill: {{VALUE}} !important',															
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing .rx_review_block .children .rx_thumb' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						' .rx_listing .rx_review_block .children .rx_thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing .rx_review_block .children .review_title' => 'color: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#707070',
					'selectors' => [
						' .rx_listing .rx_review_block .children .owner_arrow svg .st0' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#707070',
					'selectors' => [
						' .rx_listing .rx_review_block .children .comment-content p' => 'color: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing .rx_review_block .children .rx_review_calender' => 'color: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing .rx_review_block .children .rx_body .rx_review_calender svg .st0' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#000',
					'selectors' => [
						' .admin-reply-edit-icon svg' => 'fill: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#000',
					'selectors' => [
						' .admin-reply-delete-icon svg' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing .rx_review_block .rx_meta .rx-admin-reply' => 'color: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#097afa',
					'selectors' => [
						' .rx_listing .rx_review_block .rx_meta .rx-admin-reply' => 'background-color: {{VALUE}} !important'										
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#097afa',
					'selectors' => [					
						' .rx_listing .rx_review_block .rx_meta .rx-admin-reply' => 'border-color: {{VALUE}} !important',										
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing .children' => 'background-color: {{VALUE}}',					
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx-admin-edit-reply-area,  .rx-admin-reply-area' => 'background-color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#f7f7f7',
					'selectors' => [
						' .rx-admin-edit-reply-area,  .rx-admin-reply-area' => 'border-color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::SLIDER,
					'selectors' => [
						' .rx-admin-edit-reply-area,   .rx-admin-reply-area' => 'border-radius: {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}}',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => ' .rx_listing .rx_review_block .rx_body .admin-reply-form-title,
					 .rx_listing_style_1 .rx-admin-edit-reply-area .admin-reply-form-title',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#EBEBF3',
					'selectors' => [
						' .rx_listing .rx_review_block .rx_body .rx-admin-reply-area .comment-form-comment textarea,  .rx-admin-edit-reply-area .comment-form-comment textarea' => 'background-color: {{VALUE}} !important',										
					],
				]
			);
			...
			*========================*/
				...
				[
					...
					'selectors' => [
						' .rx-admin-edit-reply-area .form-submit .admin-review-edit-reply, 
						 .rx-admin-reply-area .form-submit .admin-review-reply' => 'background-color: {{VALUE}} !important',										
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx-admin-edit-reply-area .form-submit .admin-review-edit-reply,  .rx-admin-reply-area .form-submit .admin-review-reply' => 'color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => ' .rx-admin-edit-reply-area .form-submit,  .rx-admin-reply-area .form-submit',
				]
			);
			...
			*========================*/
			$this->add_control(
				...
				[
					...
					'default' => '#eeeeee',
					'selectors' => [
						'.rx-admin-edit-reply-area .form-submit .cancel-admin-edit-reply,  .rx-admin-reply-area .form-submit .cancel-admin-reply' => 'background-color: {{VALUE}} !important',										
					],
				]
			);				
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx-admin-edit-reply-area .form-submit .cancel-admin-edit-reply,  .rx-admin-reply-area .form-submit .cancel-admin-reply' => 'color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => ' .rx-admin-edit-reply-area .form-submit .cancel-admin-reply,  .rx-admin-reply-area .form-submit .cancel-admin-reply',
				]
			);		
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#6f7484',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination a' => 'color: {{VALUE}} !important',
                ],
            ]
		);
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#F3F3F7',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination a' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#fff',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination .rx-page.active a' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#2f4fff',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination .rx-page.active a' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#23527c',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination a:hover' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#2f4fff',
                'selectors' => [
                    ' .rx_listing_style_1 .rx_pagination a:hover' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'default' => '#1a1a1a',
				'selectors' => [
					' .rx-review-form-area-style-1 .rx-criteria-table td' => 'color: {{VALUE}}',
					' .rx-review-form-area-style-2 .rx-criteria-table td' => 'color: {{VALUE}}',									
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					' .rx-review-form-area-style-1 .rx_star_rating:not(:checked)>label:hover .icon-star,  .rx-review-form-area-style-1 .rx_star_rating:not(:checked)>label:hover~label .icon-star' => 'fill: {{VALUE}} !important',					
				],
			]
		);
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#3797FF',
                'selectors' => [
                    ' .rx-review-form-area-style-1 .reviewx_recommended_list .reviewx_radio input[type="radio"]:checked + .radio-label svg .rx_happy, .rx-review-form-area-style-1 .reviewx_recommended_list .reviewx_radio input[type="radio"]:checked + .radio-label svg .st1 ' => 'fill: {{VALUE}} !important',
                ],
            ]
		);
		...
		$this->add_control(
            ...
            [
				...
				'default' => '#6d6d6d',
                'selectors' => [
                    ' .rx-review-form-area-style-1 #review_form .rx-note-video' => 'color: {{VALUE}} !important',
                ],
            ]
		);
            ...
            [
                ...
                'selectors' => [
					' .rx-review-form-area-style-1 #review_form input[type="submit"], 
					 .rx-review-form-area-style-1 #review_form input[type="submit"]:focus ' => 'color: {{VALUE}} !important',
                ],
            ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
					' .rx-review-form-area-style-1 #review_form input[type="submit"], 
					 .rx-review-form-area-style-1 #review_form input[type="submit"]:focus ' => 'background-color: {{VALUE}} !important',
					// ' .rx-review-form-area-style-1 #review_form input[type="submit"], 
					//  .rx-review-form-area-style-1 #review_form input[type="submit"]:focus ' => 'border-color: {{VALUE}} !important',					
                ],
            ]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					' .rx-review-form-area-style-1 #respond input#submit' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);		
	...
	protected function template_two_style()
    {
			...
			[
				...
				'selectors' => [
					' .rx-filter-bar-style-2 .rx_filter_header h4, 
					 .rx-filter-bar-style-2 .rx-short-by h4' => 'color: {{VALUE}}',		
				],
			]
		);		
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Text Typography', 'reviewx' ),
				'selector' => ' .rx-filter-bar-style-2 .rx_filter_header h4, 
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx-filter-bar-style-2 .rx_review_shorting_2 .box select' => 'background-color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333',
				'selectors' => [
					' .rx-filter-bar-style-2 .rx_review_shorting_2 .box select' => 'color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx-filter-bar-style-2 .rx_review_shorting_2 .box .rx-selection-arrow b' => 'border-color: {{VALUE}} transparent transparent transparent !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#2f4fff',
				'selectors' => [
					' .rx-filter-bar-style-2 .rx_review_shorting_2 .box .rx-selection-arrow' => 'background-color: {{VALUE}} !important',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#f5f6f9',
				'selectors' => [
					' .rx-filter-bar-style-2' => 'background-color: {{VALUE}}',					
				],
			]
		);		
		...
		* Start Review Style
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => ' .woocommerce-tabs .rx_listing_style_2 .rx_review_block .rx_thumb',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					' .woocommerce-tabs .rx_listing_style_2 .rx_review_block .rx_thumb' => 'border-style: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					' .woocommerce-tabs .rx_listing_style_2 .rx_review_block .rx_thumb' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					' .woocommerce-tabs .rx_listing_style_2 .rx_review_block .rx_thumb' => 'border-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#373747',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .rx_author_info .rx_author_name h4' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		* *********************************/	
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFAF22',
				'selectors' => [
					' .rx_review_sort_list .rx_listing_container_style_2 .rx_listing_style_2 .rx_avg_star_color' => 'fill: {{VALUE}} !important',					
				],
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [					
					' .rx_listing_style_2 .rx_review_block .rx_body .review_rating svg' => 'width: {{SIZE}}{{UNIT}} !important; height: {{SIZE}}{{UNIT}} !important;',					
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#373747',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .review_title' => 'color: {{VALUE}}',	
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#9B9B9B',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .rx_body p' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#F5F6F9',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block' => 'background-color: {{VALUE}}',					
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					' .rx_listing_style_2.rx_listing_filter_style_2 .children,  .rx_listing_style_2 .children .rx_review_block' => 'background-color: {{VALUE}}',					
				],
			]
		);		
		...
		* *********************************/			
		...
		$this->add_control(
			...
			[
				...
				'default' => '#707070',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .rx_body .rx_review_calender svg .st0' => 'fill: {{VALUE}}',
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default' => '#707070',
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .rx_body .rx_review_calender' => 'color: {{VALUE}}',					
				],
			]
		);
		...
		if( $this->is_pro() ) {
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx_review_vote_icon p' => 'color: {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#eaeaea',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_vote_icon .like' => 'background-color: {{VALUE}}',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#A4A4A4',
					'selectors' => [
						' .rx_listing_style_2 .rx_helpful_style_2_svg svg' => 'fill: {{VALUE}}',					
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#696969',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_vote_icon .like .rx_helpful_count_val' => 'color: {{VALUE}} !important',				
					],
				]
			);		
			...
			$this->add_group_control(
				...
				[
					...
					'label' => __( 'Share Typography', 'reviewx' ),
					'selector' => ' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx_share p',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx_share p' => 'color: {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#000',
					'selectors' => [
						' .rx_listing_style_2 .social-links .wc_rx_btns ul li:nth-child(1) svg' => 'fill: {{VALUE}}',
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#B7B7B8',
					'selectors' => [
						' .rx_listing_style_2 .social-links .wc_rx_btns ul li:nth-child(2) a svg .st0' => 'fill: {{VALUE}}'	
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#B7B7B8',
					'selectors' => [
						' .rx_listing_style_2 .social-links .wc_rx_btns ul li:nth-child(3) a svg .st0' => 'fill: {{VALUE}}',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#2f4fff',
					'selectors' => [
						' .rx_listing_style_2 .rx_admin_heighlights span svg' => 'fill: {{VALUE}} !important',		
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff4df',
					'selectors' => [
						' .rx_listing_style_2 .reviewx_highlight_comment' => 'background-color: {{VALUE}} !important',					
					],
				]
			);				
			...
			$this->add_control(
				...
				[
					...
					'default' => '#FFE3AF',
					'selectors' => [
						' .rx_listing_style_2.rx_listing_filter_style_2 .reviewx_highlight_comment .children,  .rx_listing_style_2 .reviewx_highlight_comment .children .rx_review_block' => 'background-color: {{VALUE}} !important',					
					],
				]
			);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					' .rx_listing_style_2 .rx_review_block .rx_body .rx_photos' => 'justify-content: {{VALUE}} !important;',
				],
			]
		);		
		...
		* *********************************/
		...
		if( $this->is_pro() ) {
			...
			$this->add_control(
				...
				[
					...
					'default' => '#2f4fff',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .rx_thumb svg .st0' => 'fill: {{VALUE}} !important',															
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .rx_thumb' => 'background-color: {{VALUE}}',
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .rx_thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .review_title' => 'color: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#707070',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .owner_arrow svg .st0' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#707070',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .comment-content p' => 'color: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .children .rx_review_calender' => 'color: {{VALUE}} !important',					
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' => '#373747',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_review_calender svg .st0' => 'fill: {{VALUE}} !important',					
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx-admin-reply' => 'color: {{VALUE}} !important',
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#097afa',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx-admin-reply' => 'background-color: {{VALUE}} !important',					
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#097afa',
					'selectors' => [
						' .rx_listing_style_2 .rx_review_block .rx_body .rx_meta .rx-admin-reply' => 'border-color: {{VALUE}} !important',				
					],
				]
			);
				...
				[
					...
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area, 
						 .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area' => 'background-color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						' .rx_listing_container_style_2.rx-admin-edit-reply-area, 
						 .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area' => 'border-color: {{VALUE}} !important',										
					],
				]
			);
				...
				[
					...
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-reply-area,
						 .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-edit-reply-area' => 'border-radius: {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} !important',
					],
				]
			);
				...
				[
					...
					'selectors' => [
						' .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area .comment-form-comment .rx-admin-reply-text, 
						  .rx_listing_container_style_2 .rx-admin-edit-reply-area .comment-form-comment .rx-admin-reply-text' => 'background-color: {{VALUE}} !important',										
					],
				]
			);
			...
			*========================*/
				...
				[
					...
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .admin-review-edit-reply, 
						 .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area .form-submit .admin-review-reply' => 'background-color: {{VALUE}} !important',										
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#fff',
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .admin-review-reply, 
						 .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area .form-submit .admin-review-reply' => 'color: {{VALUE}} !important',										
					],
				]
			);
			...
			*=========================*/
			$this->add_control(
				...
				[
					...
					'default' => '#eeeeee',
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .cancel-admin-edit-reply,  .rx_review_block .rx_body .rx-admin-reply-area .form-submit .cancel-admin-reply' => 'background-color: {{VALUE}} !important',										
					],
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .cancel-admin-edit-reply,  .rx_review_block .rx_body .rx-admin-reply-area .form-submit .cancel-admin-reply' => 'border-color: {{VALUE}} !important',										
					],
				]
			);		
			...
			$this->add_control(
				...
				[
					...
					'default' => '#333',
					'selectors' => [
						' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .cancel-admin-edit-reply,  .rx_review_block .rx_body .rx-admin-reply-area .form-submit .cancel-admin-reply' => 'color: {{VALUE}} !important',										
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'label' => __( 'Cancel Button Typography', 'reviewx' ),
					'selector' => ' .rx_listing_container_style_2 .rx-admin-edit-reply-area .form-submit .cancel-admin-reply,  .rx_listing_container_style_2 .rx_review_block .rx_body .rx-admin-reply-area .form-submit .cancel-admin-reply',
				]
			);		
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#6f7484',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination a' => 'color: {{VALUE}} !important',
                ],
            ]
		);
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#F3F3F7',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination a' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#fff',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination .rx-page.active a' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#2f4fff',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination .rx-page.active a' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#23527c',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination a:hover' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#2f4fff',
                'selectors' => [
                    ' .rx_listing_container_style_2 .rx_pagination a:hover' => 'background-color: {{VALUE}} !important',
                ],
            ]
        );
		...
		* *********************************/
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					' => 'stroke: {{VALUE}} !important',
					' .rx-review-form-area-style-2 .rx_star_rating:not(:checked)>label:hover .icon-star,  .rx-review-form-area-style-2 .rx_star_rating:not(:checked)>label:hover~label .icon-star' => 'fill: {{VALUE}} !important',	
				],
			]
		);
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#3797FF',
                'selectors' => [
                    ' .rx-review-form-area-style-2 .reviewx_recommended_list .reviewx_radio input[type="radio"]:checked + .radio-label svg .rx_happy, .rx-review-form-area-style-2 .reviewx_recommended_list .reviewx_radio input[type="radio"]:checked + .radio-label svg .st1 ' => 'fill: {{VALUE}} !important',
                ],
            ]
		);
		...
		$this->add_control(
            ...
            [
				...
				'default' => '#6d6d6d',
                'selectors' => [
                    ' .rx-review-form-area-style-2 #review_form .rx-note-video' => 'color: {{VALUE}} !important',
                ],
            ]
		);
            ...
            [
                ...
                'selectors' => [
					' .rx-review-form-area-style-2 #review_form input[type="submit"], 
					 .rx-review-form-area-style-2 #review_form input[type="submit"]:focus' => 'color: {{VALUE}} !important',
                ],
            ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
					' .rx-review-form-area-style-2 #review_form input[type="submit"], 
					 .rx-review-form-area-style-2 #review_form input[type="submit"]:focus' => 'background-color: {{VALUE}} !important',
					' .rx-review-form-area-style-2 #review_form input[type="submit"], 
					 .rx-review-form-area-style-2 #review_form input[type="submit"]:focus' => 'border-color: {{VALUE}} !important',
                ],
            ]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					' .rx-review-form-area-style-2 #respond input#submit' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);		
    ...
    protected function render()
    {
		...
		//title
		echo '<h2 class="cpt-reviews-title"> ' . $rx_template_type['rx_review_section_title'] . '</h2>';
